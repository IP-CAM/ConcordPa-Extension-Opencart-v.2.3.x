...
class ControllerExtensionPaymentConcordpay extends Controller
{
	...
	$this->load->model('checkout/order');
        ...
        $callback_url = $this->url->link('extension/payment/concordpay/callback', '', true);
        $approve_url = $this->url->link('extension/payment/concordpay/approve', '', true);
        $cancel_url = $this->url->link('extension/payment/concordpay/decline', '', true);
        $decline_url = $this->url->link('extension/payment/concordpay/decline', '', true);
        ...
        return $this->load->view('extension/payment/concordpay.tpl', $data);
    }
